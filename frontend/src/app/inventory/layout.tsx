...
export default function InventoryLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs = [
    { name: "Stock Management", path: "/inventory/stock", icon: Package, roles: ["SUPER_ADMIN", "MANAGER", "STAFF"] },
    { name: "Waste Log", path: "/inventory/waste", icon: Trash2, roles: ["SUPER_ADMIN", "MANAGER", "STAFF"] },
  ]
