  ...
  return (
    <AnimatedPage className="max-w-[1600px] w-full mx-auto space-y-6 h-full flex flex-col">
      <div className="flex justify-between items-end shrink-0">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100 text-balance">Point of Sale</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Process sales and manage cash register.</p>
        </div>
      </div>
